...
class Asso_donation
{
    public function update(){
        ...
        if(isset($_POST["cli_id"])) {
            ...
            (new \Manager\Asso_donation($bdd))->update();

        }

        /* affichage des données , renvoi un arrray */

        $donation = (new \Manager\Asso_donation($bdd))->get();
        ...
        $box_donation = (new \Controller\Back\htmlElement\Box('Modifier un don','box-primary',$box_donation_content,$col_md))->render();
